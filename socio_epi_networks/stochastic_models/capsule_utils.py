...
# Functions
def create_sparse_matrix_from_capsules(sizes, capsules):
    """
...
def stochastic_block_model_sparse_undirected_triu(sizes, p):
    """
...
def slice_sparse_matrix_by_indices(sparse_matrix, indices_to_slice, axis, device):
    """
...
def reconstruct_block_model_from_sparse_matrix(sparse_matrix, sizes, device):
    """
